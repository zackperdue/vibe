...
run_test "tests/test_no_parens_functions.vi" "Functions without Parentheses"
run_test "tests/test_no_return_type_function.vi" "Functions without Return Types"
run_test "tests/test_no_parens_no_return_type.vi" "Functions without Parentheses and without Return Types"
